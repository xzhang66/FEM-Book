...
e_xx = strain(1,:);  e_yy = strain(2,:);  e_xy = strain(3,:);     % strains at the nodes 
s_xx = stress(1,:);  s_yy = stress(2,:);  s_xy = stress(3,:);     % stress at the nodes 
...
%nodestress(je,:) = [s_xx'    s_yy'    s_xy' ];   % original version  